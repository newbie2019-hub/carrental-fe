  ...
  <div class="home">
    ...
    <div id="cars" class="container pb-5 pt-5">
      ...
      <div class="row justify-content-center align-items-stretch mt-5">
        <div class="col-10 col-sm-10 col-md-4 col-lg-4 col-xl-4 mt-2 " v-for="(car, i) in homecars" :key="i">
          <div class="card h-100 p-3">
             <img :src="'https://carrental-cloudbased-be.herokuapp.com/uploads/' + car.image" class="card-img-top" alt="...">
             <div class="card-body mt-3">
               <h5 class="card-title">{{car.brand.brand}} {{car.model}}</h5>
               <p class="mt-3">Transmission: {{car.transmission.type}}</p>
               <p class="">Rate/Day: {{formatCurrency(car.rate.per_day)}}</p>
               ...
               <a href="#" class="btn btn-primary rounded-pill mt-3" v-on:click.prevent="selectedcar = car; reserve()">Reserve</a>
            </div>
          </div>
        </div>
      </div>
